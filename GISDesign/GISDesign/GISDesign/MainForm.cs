...
namespace GISDesign
{
    public sealed partial class MainForm : Form
    {
       ...
       private void toolStripMenuItem1_Click(object sender, EventArgs e)
        ...
        {
            GuassianFrm GUA = new GuassianFrm();
            GUA.ShowDialog();
        }

        private void cannyExctractionToolStripMenuItem_Click(object sender, EventArgs e)
        {
            CannyExatraction Can = new CannyExatraction();
            Can.ShowDialog();
        }

        private void curveFittingToolStripMenuItem_Click(object sender, EventArgs e)
        {
            CurveFitting Fit = new CurveFitting();
           Fit.ShowDialog();
        }
